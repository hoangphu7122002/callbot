...
class FSCallBotSimple:
    def __init__(self, media_port, uuid, sip_from):
        ...
        self.current_phone = sip_from  # Thêm biến để lưu số điện thoại
    ...
    async def play_processing_message(self, uuid):
        ...
        processing_file = "./records/processing.wav"
    ...
    async def play_goodbye_message(self, uuid):
        ...
        try:
            ...
            goodbye_file = "./records/goodbye_trung.wav"
    ...
    async def process_audio(self, audio_data, uuid):
        ...
        try:
            ...
            output_file = f"./records/response_{uuid}.wav"
    ...
    async def play_welcome_message(self, uuid):
        ...
        welcome_file = "./records/welcome_vcbs.wav"
        self.playback_event.set()
...
def process_call(ch, method, properties, body):
    ...
    # Xử lý audio & chatbot
    bot = FSCallBotSimple(media_port, uuid, sip_from)
